...
<iframe src="resources/electricity_plotly.html" width = "1000px", height = "500px" seamless="seamless" frameBorder="0"></iframe> 
...
p <- food_bc %>% 
  ...
  geom_line() + 
  transition_states(lambda, state_length = 0) + 
  view_follow() + 
  ggtitle("Box-Cox transformed food retailing turnover (lambda = {closest_state})")
